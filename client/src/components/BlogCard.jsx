                ...
                <div className="h-[216px] m-4  relative flex">
                    <div className='w-2/3 relative'>
                        ...
                        <div className='w-full font-[GillSans]'>
                            <h1 className={`${props.titleClassNames ? props.titleClassNames : 'text-lg'} font-semibold mt-3 leading-4 text-text-100 dark:text-darkText-100`}>{heading}</h1>
                            <p className={`${props.contentClassNames ? props.contentClassNames : 'text-xs'} font-regular mt-2 text-text-200 dark:text-darkText-200`}>
                                {truncatedText}
                            </p>
                        </div>
